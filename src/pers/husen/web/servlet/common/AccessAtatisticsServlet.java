 ...
 * 2017年10月18日
 */
@WebServlet("/AccessAtatisticsServlet")
public class AccessAtatisticsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public AccessAtatisticsServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String jsonReturn = JSONObject.fromObject(aPo).toString();
