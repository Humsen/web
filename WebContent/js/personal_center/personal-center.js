		...
		success : function(response){
			...
			$("#mainWindow").append(
				...
				'<div class="form-group">' +
					...
					'<div class="col-sm-10">' +
						'<p class="form-control-static" style="width: 30%;">' + response.userName + '</p>' +
					'</div>' +
				'</div>' +
				'<div class="form-group">' +
					'<label class="col-sm-2 control-label">邮箱</label>'+
					'<div class="col-sm-10">' +
						'<p class="form-control-static" style="width: 30%;">'+ response.userEmail +'</p>' +
					'</div>' +
				'</div>' +
				'<div class="form-group">' +
					'<label class="col-sm-2 control-label">手机</label>'+
					'<div class="col-sm-10">' +
						'<p class="form-control-static" style="width: 30%;">'+ response.userPhone +'</p>' +
					'</div>' +
				'</div>' +
				'<div class="form-group">' +
					'<label class="col-sm-2 control-label">年龄</label>'+
					'<div class="col-sm-10">' +
						'<p class="form-control-static" style="width: 30%;">'+ response.userAge +'</p>' +
					'</div>' +
				'</div>' +
				'<div class="form-group">' +
					'<label class="col-sm-2 control-label">地址</label>'+
					'<div class="col-sm-10">' +
						'<p class="form-control-static" style="width: 30%;">'+ response.userAddress +'</p>' +
					'</div>' +
				'</div>' +
				'</form>'
			);
