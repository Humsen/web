				...
				onContentReady : function() {
					...
					$("#btn_sendValidateCode").click(
							function() {
								...
								var $btnSendCode = $("#btn_sendValidateCode");
								$btnSendCode.html('重发(<label id="txt_secondsCount" style="margin-bottom: 0;">60</label>s)');
								//$btnSendCode.attr("hassend", true);
 ...
 * @returns
 */
function codeCountDown($btnSendCode) {
